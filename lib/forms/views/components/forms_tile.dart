    ...
    return Container(
      ...
      child: MaterialButton(
          ...
          onHighlightChanged: (highlight) {
            setState(() => _highlighted = highlight);
          },
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(height: 1, decoration: TextDecoration.none, fontSize: 18, color: Colors.white, fontFamily: CompodFonts.Palanquin, fontWeight: FontWeight.w500),
                )
              ],
            ),
          )),
